...
if ( ! function_exists( 'ch_widgets_init' ) ) {
	...
	function ch_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'pdc' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'pdc' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'pdc' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'pdc' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer', 'pdc' ),
				'id'            => 'footer-full',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'pdc' ),
