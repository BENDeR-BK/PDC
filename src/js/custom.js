	...
	chThemeModule = (function() {
		...
		return {
			...
			filterLIbrary : function() {
				let filterBtnType = 'Всі'
				let filterBtnLang = 'Всі'

				$('[data-btn]').on('click', function () {
					let activeItem = $(this).data('filter')
					let filterBtn = $(this).data('btn')
					...
					let parentBlock = $('.lib-item.Всі').parent()
			...
			searchText : function() {
				...
				// var allBlogText = $('.blog-item__text')
			...
			categoryMenu : function() {
				...
				let activeProdCat = $('.active-product-category').text().trim()
			 ...
			 *-------------------------------------------------------------------------------------------------------------------------------------------
			 */
			menuPostsAjax : function() {
				console.log('ready')
				$('.sub-content > a').on('click',function(e){
					// e.preventDefault()
				})
				...
				$('.sub-content').on('click',function(e){ 
			 ...
			 *-------------------------------------------------------------------------------------------------------------------------------------------
			 */
			 MainFilterPostsAuthors: function() {
			 ...
			 *-------------------------------------------------------------------------------------------------------------------------------------------
			 */
			aboutAuthorsSlider: function() {
				
				var $aboutAuthorsSlider = $('.about-authors__slider')
				...
				$('.teg-item__chek').on('change', function(){
					...
					chekbokses.each(function( index ) {
						if($(this).prop('checked')) {
							var i = $( this ).val()
							TagsCurent.push(i)
							$('#inputCurentTags').val(TagsCurent)
							// console.log(TagsCurent);
